    ...
    for (int i = 0; i < text.num; i++) {
        ...
        do {
            ...
            if (t) {
                ...
                dates[k] = wcstol(str_orig + (t - str_copy), NULL, 10) +
                           100 * wcstol(str_orig + (t - str_copy + 3), NULL, 10) + 10000 * wcstol(year, NULL, 10);
                dates[k] *= 10;
                dates[k] += 5;
                k++;
        ...
        do {
            ...
            if (t) {
                ...
                dates[k] = 10000 * wcstol(str_orig + (t - str_copy), NULL, 10) +
                           100 * wcstol(str_orig + (t - str_copy + 5), NULL, 10) + wcstol(day, NULL, 10);
                dates[k] *= 10;
                k++;
